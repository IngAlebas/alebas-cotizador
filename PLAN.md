...
> **Versión:** 1.7 · **Fecha:** 24 mayo 2026  
...
| 2026-05-24 | v1.7 | Sesión 3 — Fix regresión estimador de techo (PR #165): Quoter.jsx conectado a places.js (autocomplete Google Places debounced 350ms, dropdown sugerencias mainText/secondaryText) + InteractiveRoofMap renderizado cuando lat/lon disponible + onMapPinMove para re-estimación por drag de pin. Root cause: servicios y componente ya existían pero nunca se importaron en Quoter.jsx |
