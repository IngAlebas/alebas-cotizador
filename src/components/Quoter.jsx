    ...
    <div style={ss.wrap}>
      <div style={{ ...ss.card, textAlign: 'center', padding: '44px 22px', borderColor: C.teal }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginBottom: 16 }}>
          <img src={logo} alt="SolarHub" style={{ height: 52, width: 52 }} />
          <div style={{ textAlign: 'left', lineHeight: 1 }}>
            <div style={{ fontFamily: 'system-ui', fontWeight: 900, fontSize: 28, letterSpacing: '-1px', color: '#fff' }}>SOLAR</div>
            <div style={{ fontFamily: 'system-ui', fontWeight: 300, fontSize: 28, letterSpacing: '6px', color: '#FF8C00' }}>HUB</div>
          </div>
        </div>
        <div style={{ color: '#FF8C00', fontSize: 11, letterSpacing: 3, marginBottom: 16, fontWeight: 600, textTransform: 'uppercase' }}>El ecosistema solar de Colombia</div>
        ...
        <div style={{ display: 'flex', gap: 7, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 24 }}>
          {['✓ 17 operadores de red', '✓ RETIE + CREG 174/2021', '✓ Transporte a 33 departamentos'].map(t => (
    ...
    return (
      <div style={ss.wrap}>
        ...
        <div style={{ textAlign: 'center', padding: '4px 0 28px' }}>
          ...
          <div style={{ fontSize: 11, color: C.muted }}>Ingeniero SolarHub te contacta en menos de 24h · info@alebas.co</div>
        </div>
      </div>
    );
  }
