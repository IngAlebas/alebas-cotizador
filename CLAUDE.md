...
Backend   n8n               →  api.solar-hub.co
DB        PostgreSQL        →  conectada al n8n actual
```
...
| `api.solar-hub.co` | n8n (host actual) | Hostinger |

**n8n actual:** `api.solar-hub.co` ✅
- PostgreSQL conectado ✅
- Workflows pendientes de importar/activar (ver `DEPLOY.md`)
